...
class GerarPedido extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            pagamento: ['Débito/Crédito por link', 'Pix'],
            enderecosDoUsuario: [],
        ...
        fetch('https://env-9048989.jelastic.saveincloud.net/api/petshop/status=' + this.state.IdPetshop, {
            ...
            .then(data => {
                if (data[0].status == true) {
                    ...
                    const destino = {
                        endereco: this.state.endereco + ', ' + this.state.numero + " - " + this.state.bairro + " (" + this.state.cidade + ", " + this.state.estado + ")",
